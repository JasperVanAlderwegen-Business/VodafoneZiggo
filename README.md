...
1. Since I only started at iO on Monday, I did not have a set up laptop yet. Because of this, I had to combine the setup
...
2. Most JavaDoc comments were generated using IntelliJ’s AI Assistant. This approach saves time while providing a clear
   and consistent level of documentation quality.
3. The Reqres.in api does not have any way of retrieving a single user by e-mail. For that reason, when retrieving a
